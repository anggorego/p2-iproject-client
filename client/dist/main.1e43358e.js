  ...
  methods: {
    clickButtonLogin: function clickButtonLogin() {
      ...
      _axios.default.post("http://localhost:3000/login", {
        ...
        _this.$emit("directToHome", "homePage");
      }).catch(function (err) {
        swal({
          title: "FAILED",
          text: "Invalid email/password",
...
exports.default = _default;
        var $2eb44b = exports.default || module.exports;
      
      if (typeof $2eb44b === 'function') {
        $2eb44b = $2eb44b.options;
      }
    
        /* template */
        Object.assign($2eb44b, (function () {
          var render = function () {
  var _vm = this
          ...
          "button",
          {
            ...
            on: {
              click: function ($event) {
                ...
                return _vm.clickButtonLogin.apply(null, arguments)
              },
            },
          },
          [_vm._v("Submit")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2eb44b', $2eb44b);
          } else {
            api.reload('$2eb44b', $2eb44b);
          }
        }
...
},{"axios":"node_modules/axios/index.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/views/RegisterPage.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    clickButtonRegister: function clickButtonRegister() {
      var _this = this;
      ...
      _axios.default.post("http://localhost:3000/register", {
        ...
        _this.$emit("directToLogin", "loginPage");
      }).catch(function (err) {
        console.log(err);
        swal({
          title: "FAILED",
    ...
    clickButtonLoginRegister: function clickButtonLoginRegister() {
      this.$emit("directToLogin", "loginPage"); // this.isRegister = true
      // this.isLogin = true
    }
  }
};
exports.default = _default;
        var $1a4497 = exports.default || module.exports;
      
      if (typeof $1a4497 === 'function') {
        $1a4497 = $1a4497.options;
      }
    
        /* template */
        Object.assign($1a4497, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      _c("fieldset", [
        ...
        _c("div", { staticClass: "form-group" }, [
          ...
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.phoneRegister,
                expression: "phoneRegister",
              },
            ],
            staticClass: "form-control",
            attrs: {
            ...
            domProps: { value: _vm.phoneRegister },
            on: {
              input: function ($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.phoneRegister = $event.target.value
              },
            },
          }),
        ]),
        ...
        _c(
          "button",
          {
            ...
            on: {
              click: function ($event) {
                $event.preventDefault()
                return _vm.clickButtonRegister.apply(null, arguments)
              },
            },
          },
          [_vm._v("Submit")]
      ...
      _c(
        "button",
        {
          ...
          on: {
            click: function ($event) {
              $event.preventDefault()
              return _vm.clickButtonLoginRegister.apply(null, arguments)
            },
          },
        },
        [_vm._v("login here")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1a4497', $1a4497);
          } else {
            api.reload('$1a4497', $1a4497);
          }
        }
...
var _default = {
  ...
  methods: {
    clickHrefThread: function clickHrefThread() {
      this.$emit("directToThreadsList", "threadsPage");
    },
    clickHrefHome: function clickHrefHome() {
...
exports.default = _default;
        var $48d281 = exports.default || module.exports;
      
      if (typeof $48d281 === 'function') {
        $48d281 = $48d281.options;
      }
    
        /* template */
        Object.assign($48d281, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
                  ...
                  _c(
                    "a",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          $event.preventDefault()
                          return _vm.clickHrefHome.apply(null, arguments)
                        },
                      },
                    },
                    [_vm._v("Home\n            ")]
                  ...
                  _c(
                    "a",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          $event.preventDefault()
                          return _vm.clickHrefThread.apply(null, arguments)
                        },
                      },
                    },
                    [_vm._v("My Threads")]
                  ...
                  _c(
                    "a",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          $event.preventDefault()
                          return _vm.clickHrefLogOut.apply(null, arguments)
                        },
                      },
                    },
                    [_vm._v("sign out")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$48d281', $48d281);
          } else {
            api.reload('$48d281', $48d281);
          }
        }
...
exports.default = _default;
        var $e78f3b = exports.default || module.exports;
      
      if (typeof $e78f3b === 'function') {
        $e78f3b = $e78f3b.options;
      }
    
        /* template */
        Object.assign($e78f3b, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e78f3b', $e78f3b);
          } else {
            api.reload('$e78f3b', $e78f3b);
          }
        }
...
},{"vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/threads.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    fetchThreads: function fetchThreads() {
      ...
      _axios.default.get("http://localhost:3000/threads", {
        headers: {
...
exports.default = _default;
      ...
      if (typeof $2b8a10 === 'function') {
        $2b8a10 = $2b8a10.options;
      }
    
        /* template */
        Object.assign($2b8a10, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2b8a10', $2b8a10);
          } else {
            api.reload('$2b8a10', $2b8a10);
          }
        }
...
var _addThread = _interopRequireDefault(require("../components/addThread.vue"));

var _threads = _interopRequireDefault(require("../components/threads.vue"));
...
var _default = {
  ...
  methods: {
    ...
    fetchUser: function fetchUser() {
      ...
      _axios.default.get("http://localhost:3000/user", {
        headers: {
          access_token: localStorage.access_token
        }
      }).then(function (res) {
        ...
        _this.$emit("userData", _this.user);
      }).catch(function (err) {
        console.log(err);
      });
    },
...
exports.default = _default;
        var $b00bbc = exports.default || module.exports;
      
      if (typeof $b00bbc === 'function') {
        $b00bbc = $b00bbc.options;
      }
    
        /* template */
        Object.assign($b00bbc, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b00bbc', $b00bbc);
          } else {
            api.reload('$b00bbc', $b00bbc);
          }
        }
...
var _default = {
  ...
  methods: {
    clickButtonComment: function clickButtonComment(id) {
      var _this = this;

      _axios.default.post("http://localhost:3000/comments/".concat(id), {
...
exports.default = _default;
        var $8c8a30 = exports.default || module.exports;
      
      if (typeof $8c8a30 === 'function') {
        $8c8a30 = $8c8a30.options;
      }
    
        /* template */
        Object.assign($8c8a30, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "form-group" }, [
      _c(
        "label",
        { staticClass: "form-label mt-4", attrs: { for: "exampleTextarea" } },
        [_vm._v("comment below")]
      ),
      _vm._v(" "),
      _c("textarea", {
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.descriptionComment,
            expression: "descriptionComment",
          },
        ],
        staticClass: "form-control",
        ...
        on: {
          input: function ($event) {
            ...
            _vm.descriptionComment = $event.target.value
          },
        },
      }),
      _vm._v(" "),
      _c(
        "button",
        {
          ...
          on: {
            click: function ($event) {
              return _vm.clickButtonComment(_vm.threadData.id)
            },
          },
        },
        [_vm._v("Submit")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$8c8a30', $8c8a30);
          } else {
            api.reload('$8c8a30', $8c8a30);
          }
        }
...
var _default = {
  ...
  methods: {
    fetchThreadsByUser: function fetchThreadsByUser() {
      var _this = this;

      _axios.default.get("http://localhost:3000/threads/byuser", {
        headers: {
          access_token: localStorage.access_token
        }
      }).then(function (res) {
...
exports.default = _default;
        var $c52a50 = exports.default || module.exports;
      
      if (typeof $c52a50 === 'function') {
        $c52a50 = $c52a50.options;
      }
    
        /* template */
        Object.assign($c52a50, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c52a50', $c52a50);
          } else {
            api.reload('$c52a50', $c52a50);
          }
        }
...
var _default = {
  ...
  methods: {
    fetchThreadById: function fetchThreadById() {
      var _this = this;

      _axios.default.get("http://localhost:3000/threads/".concat(this.threadDetailId.id), {
        headers: {
          access_token: localStorage.access_token
        }
      }).then(function (res) {
  ...
  watch: {
    "comments": function comments(val) {// this.fetchThreadById()
    }
  }
};
exports.default = _default;
        var $1e79e7 = exports.default || module.exports;
      
      if (typeof $1e79e7 === 'function') {
        $1e79e7 = $1e79e7.options;
      }
    
        /* template */
        Object.assign($1e79e7, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _c("table", { staticClass: "table table-hover w-auto " }, [
        ...
        _c(
          ...
          _vm._l(_vm.comments, function (comment) {
            return _c("tr", { key: comment.id, staticClass: "table-dark" }, [
              _c("th", { attrs: { scope: "row" } }, [
      ...
      _vm._v(" "),
      _c("Comment", {
        attrs: { threadData: _vm.threadDetailId },
        on: { backToHome: _vm.backToHome },
      }),
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1e79e7', $1e79e7);
          } else {
            api.reload('$1e79e7', $1e79e7);
          }
        }
...
},{"../components/Comment.vue":"src/components/Comment.vue","axios":"node_modules/axios/index.js","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/views/ThreadForm.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    clickButtonThread: function clickButtonThread() {
      var _this = this;

      _axios.default.post("http://localhost:3000/threads", {
...
exports.default = _default;
        var $656643 = exports.default || module.exports;
      
      if (typeof $656643 === 'function') {
        $656643 = $656643.options;
      }
    
        /* template */
        Object.assign($656643, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    _c("form", [
      ...
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("input", {
          ...
          on: {
            input: function ($event) {
              ...
              _vm.titleForm = $event.target.value
            },
          },
        }),
        _vm._v(" "),
        ...
        _c("textarea", {
          ...
          staticClass: "form-control",
          attrs: { id: "exampleTextarea", rows: "3" },
          domProps: { value: _vm.descForm },
          on: {
            input: function ($event) {
              if ($event.target.composing) {
                return
              }
              _vm.descForm = $event.target.value
            },
          },
        }),
      ]),
      ...
      _c(
        "button",
        {
          ...
          on: {
            click: function ($event) {
              $event.preventDefault()
              return _vm.clickButtonThread.apply(null, arguments)
            },
          },
        },
        [_vm._v("Submit")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$656643', $656643);
          } else {
            api.reload('$656643', $656643);
          }
        }
...
var _ThreadPage = _interopRequireDefault(require("./views/ThreadPage.vue"));

var _Navbar = _interopRequireDefault(require("./components/Navbar.vue"));

var _Threaddetail = _interopRequireDefault(require("./views/Threaddetail.vue"));

var _ThreadForm = _interopRequireDefault(require("./views/ThreadForm.vue"));
...
var _default = {
  ...
  methods: {
    directToHome: function directToHome(page) {
      if (localStorage.access_token) {
        this.pageName = page;
      }
    },
    directToLogin: function directToLogin(page) {
      this.pageName = page;
    },
    backToLogin: function backToLogin(page) {
      localStorage.clear();
      this.pageName = page;
    },
    directToThreadsList: function directToThreadsList(page) {
      this.pageName = page;
    },
    threadDetailId: function threadDetailId(page, thread) {
      this.pageName = page;
    ...
    directToPostThread: function directToPostThread(page) {
      this.pageName = page;
    },
    afterPostThread: function afterPostThread(page) {
      this.pageName = page;
    },
  ...
  components: {
    ...
    Home: _Home.default,
    ThreadPage: _ThreadPage.default,
    Navbar: _Navbar.default,
    ThreadDetail: _Threaddetail.default,
    ThreadForm: _ThreadForm.default
  },
  created: function created() {
    if (localStorage.access_token) {
...
exports.default = _default;
        var $0e9cfe = exports.default || module.exports;
      
      if (typeof $0e9cfe === 'function') {
        $0e9cfe = $0e9cfe.options;
      }
    
        /* template */
        Object.assign($0e9cfe, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _vm.pageName == "threadForm"
        ? _c("Navbar", {
            attrs: { userName: _vm.user },
            on: {
              directToThreadsList: _vm.directToThreadsList,
              backToHome: _vm.backToHome,
              backToLogin: _vm.backToLogin,
              directToPostThread: _vm.directToPostThread,
            },
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.pageName == "registerPage"
        ? _c("Register", {
            on: {
              directToLogin: _vm.directToLogin,
        ...
        ? _c("ThreadDetail", {
            attrs: {
              threadDetailId: _vm.thread,
              threadDetailIdThreadPage: _vm.threadfromthreadPage,
            },
            on: { backToHome: _vm.backToHome },
          })
        : _vm.pageName == "threadForm"
        ? _c("ThreadForm", { on: { afterPostThread: _vm.afterPostThread } })
        : _vm._e(),
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0e9cfe', $0e9cfe);
          } else {
            api.reload('$0e9cfe', $0e9cfe);
          }
        }
...
},{"./views/Login.vue":"src/views/Login.vue","./views/RegisterPage.vue":"src/views/RegisterPage.vue","./views/Home.vue":"src/views/Home.vue","./views/ThreadPage.vue":"src/views/ThreadPage.vue","./components/Navbar.vue":"src/components/Navbar.vue","./views/Threaddetail.vue":"src/views/Threaddetail.vue","./views/ThreadForm.vue":"src/views/ThreadForm.vue","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
